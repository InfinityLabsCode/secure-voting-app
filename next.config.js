...
const nextConfig = {
  ...
  env: {
    ...
    REACT_APP_TRANSACTION_BASE_UR : process.env.REACT_APP_TRANSACTION_BASE_UR,
    ASSET_PREFIX: process.env.ASSET_PREFIX,
    REACT_APP_MAXIMUM_MINT_LIMIT : process.env.REACT_APP_MAXIMUM_MINT_LIMIT,
    REACT_APP_NFT_MINTING_SMART_CONTRACT : process.env.REACT_APP_NFT_MINTING_SMART_CONTRACT,
  },
