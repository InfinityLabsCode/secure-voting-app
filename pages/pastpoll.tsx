      ...
      <div className="flex-auto">
        <div className="max-w-3xl mx-auto pt-10 pb-12 px-8">
          <div className="bg-white mt-8 px-4 mobile:p-6 py-5 border-t-4 border-orange-300 overflow-visible rounded-md border-x border border-[#e5e7eb] border-t-[#0a0a2f]">
            ...
            <ul className="max-w-2xl mx-auto p-2  rounded-md border border-[#e5e7eb] cursor-pointer">
              <li className="text-base text-[#0A0A2F] mobile:text-lg font-bold">CEO Election</li>
              <li className="text-right mobile:text-left mobile:text-xs text-sm py-1">User Voter : 1205</li>
              <li>
            ...
            <ul className="max-w-2xl mx-auto p-2  rounded-md border border-[#e5e7eb] cursor-pointer mt-4">
              <li className="text-base text-[#0A0A2F] mobile:text-lg font-bold">Manager Election</li>
              <li className="text-right mobile:text-left mobile:text-xs text-sm py-1">User Voter : 1250</li>
              <li>
                <ul className="space-x-20 content-center">
                  <li className="flex text-[#079D0D] text-sm mt-1">
                    <span className="w-2 h-2 mt-1 mr-2 rounded-full bg-[#079D0D]"></span>
            ...
            <ul className="max-w-2xl mx-auto p-2  rounded-md border border-[#e5e7eb] cursor-pointer mt-4">
              ...
              <li className="text-right mobile:text-left mobile:text-xs text-sm py-1">User Voter : 1850</li>
              <li>
                <ul className="space-x-20 content-center">
                  <li className="flex text-[#079D0D] text-sm mt-1">
                    <span className="w-2 h-2 mt-1 mr-2 rounded-full bg-[#079D0D]"></span>
            ...
            <ul className="max-w-2xl mx-auto p-2  rounded-md border border-[#e5e7eb] cursor-pointer mt-4">
              ...
              <li className="text-right mobile:text-left mobile:text-xs text-sm py-1">User Voter : 1950</li>
              <li>
                <ul className="space-x-20 content-center">
                  <li className="flex text-[#079D0D] text-sm mt-1">
                    <span className="w-2 h-2 mt-1 mr-2 rounded-full bg-[#079D0D]"></span>
