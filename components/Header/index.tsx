...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-30 bg-white  ring-1 ring-gray-300 shadow-sm">
        ...
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center desktop:hidden">
            <button
              ...
              type="button"
              className="inline-flex items-center justify-center p-2 rounded-md text-[#0A0A2F] hover:text-[#0A0A2F] hover:bg-[#0A0A2F]"
      ...
      <div
        className={`absolute top-0 inset-x-0 p-2 transition transform origin-top-right ${!showMobile ? 'hidden' : ''}`}
      >
        <div className="rounded-lg shadow-lg ring-1 ring-gray-300  bg-white divide-y-2 divide-gray-50 ">
          <div className="pt-5 pb-6 px-5">
            <div className="flex items-center justify-between flex-row-reverse">
              ...
              <div>
                <a onClick={() => router.push('all')} className="flex-shrink-0 flex items-center text-gray-900">
                  SecurePoll
                </a>
              </div>
            </div>
