        ...
        <div className="flex justify-between h-16">
          <div className="flex px-2 lg:px-0 truncate">
            ...
            <div className="flex ml-6 flex space-x-8">
              <a
                href="#"
                className="border-transparent text-gray-700 hover:border-gray-300 hover:text-gray-700 dark:hover:text-gray-300 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium whitespace-nowrap"
              >
                Create Poll
              </a>
              <a
